...
lantern.addEventListener('click', function(){
  ...
  cover.style.background = 'radial-gradient(circle, rgba(25,4,68,0) 10%, #49708A 15%, #88ABC2 98%)';
  console.log('arroz');
  setTimeout(function(){
    cover.style.background = 'radial-gradient(circle, rgba(25,4,68,0) 4%, #49708A 10%, #88ABC2 98%)';
  }, 5000);
